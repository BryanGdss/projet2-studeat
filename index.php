...
<div class="recherche">
  <form class="d-flex" role="search" id="Adresse">
    ...
    <input class="form-control me-2" type="search" placeholder="Adresse (Ville, code postal, rue, etc.) "
      aria-label="Search">
    <a href="<?php echo 'commande'; ?>" class="btn btn-outline-success" type="submit"> <i
        class="fa-solid fa-magnifying-glass fa-beat" style="color: #000;"></i></a>
  </form>
</div>
...
<div class="row row-cols-1 row-cols-md-3 g-4 nav justify-content-center" id="corps">
  ...
  <div class="col">
    <div class="card">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/commander.png" class="card-img-top"
        alt="L'image ne s'affiche pas.">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/livreur.png" class="card-img-top"
        alt="L'image ne s'affiche pas.">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="<?php echo get_template_directory_uri(); ?>/assets/img/partenaire.png" class="card-img-top"
        alt="L'image ne s'affiche pas.">
      <div class="card-body">
        <h5 class="card-title">Devenir partenaire</h5>
        <p class="card-text">Devenez un restaurant partenaire avec Stud' Eat afin de liquider vos invendus et éviter le
          gaspillage.</p>
...
<div class="text">
  ...
  <div class="row row-cols-1 row-cols-md-2 g-4">
    <div class="col">
      <div class="card">
        <div class="card-body">
          <h3 class="card-title">Les <span><img class="cardimg"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/test.png" alt="L'image ne s'affiche pas"
                width="7%" height="7%"></span>étudiants</h3>
    ...
    <div class="col">
      <div class="card">
        <div class="card-body">
          <h3 class="card-title">Les <span><img class="cardimg"
                src="<?php echo get_template_directory_uri(); ?>/assets/img/test2.png" alt="L'image ne s'affiche pas"
                width="15%" height="15%"></span> restaurants</h3>
          <br><br>
